...
class Game:
    ...
    def load_data(self):
        ...
        sound_folder = os.path.join(game_folder, "ressources\\sounds")
        self.walk_sound = pg.mixer.Sound(
            os.path.join(sound_folder, 'sound_effect_walk.mp3'))
        pg.mixer.music.load(os.path.join(sound_folder, 'sound_undertale.mp3'))

        map_folder = os.path.join(game_folder, 'ressources/maps')
        ...
        img_folder = os.path.join(
            game_folder, 'ressources\\images\\characters\\Heros\\hero_behind')
        self.player_image = pg.image.load(os.path.join(
            img_folder, 'Hero_Behind_0.png')).convert_alpha()

        font_folder = os.path.join(game_folder, 'ressources\\fonts')
    ...
    def draw(self):
        ...
        if self.pause:
            ...
            self.draw_text("Pause", self.title_font, 50, RED,
                           WIDTH / 2, HEIGHT / 2, align="center")
            self.draw_text("Menu", self.title_font, 25, WHITE,
                           WIDTH / 2, HEIGHT / 1.7, align="center")
            self.draw_text("Quitter", self.title_font, 25, WHITE,
                           WIDTH / 2, HEIGHT / 1.5, align="center")
