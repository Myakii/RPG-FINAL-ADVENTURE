...
class Inventory:
    ...
    def init_inventory(self):
        ...
        self.inventory.update(
            {self.potion_str: self.potion_str.get_quantity()})
        self.inventory.update(
            {self.potion_res: self.potion_res.get_quantity()})
        self.inventory.update(
            {self.potion_spd: self.potion_spd.get_quantity()})
