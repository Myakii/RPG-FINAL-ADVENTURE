...
thari = Character(json_class("warrior"))
# Chrisline
kai = Character(json_class("priest"))
# Lorys
lo = Character(json_class("explorer"))
# Valentin
valette = Character(json_class("lancer"))
# Player
player = Character(json_class("heros"))
